...
import { CheckCircle2, Star, Beaker } from "lucide-react";
...
export default function ProductDetailPage({ params }) {
  ...
  const productSchema = {
    ...
    description:
      product.description ||
      `Professional ${product.name} for infection control and spill management.`,
      ...
      <main className="pt-6 pb-20">
        ...
        <div className="mx-5 sm:mx-10 md:mx-20 lg:mx-32 mb-8">
          ...
          >
            <Link
              href="/"
              className="text-[#5A5A5A] hover:text-[#F37303] transition-colors flex items-center gap-1"
            >
              <svg
                className="w-4 h-4"
                fill="none"
            ...
            <Link
              href="/products"
              className="text-[#5A5A5A] hover:text-[#F37303] transition-colors"
            >
              Products
            </Link>
            <svg
            ...
            <span className="text-[#F37303] font-medium line-clamp-1">
              {product.name}
            </span>
          </motion.nav>
        </div>
              ...
              >
                ...
                >
                  {[
                    ...
                    { Icon: Beaker, label: "Safe Formula" },
                  ].map((badge, idx) => (
                    <motion.div
                      key={badge.label}
                    ...
                    >
                      <badge.Icon className="w-4 h-4 text-[#F37303]" />
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <Link href="/contactus" className="flex-1">
                      <motion.button
                        ...
                        whileHover={{
                          scale: 1.02,
                          boxShadow: "0 20px 40px rgba(243, 115, 3, 0.3)",
                        }}
                        whileTap={{ scale: 0.98 }}
                      >
                        <svg
