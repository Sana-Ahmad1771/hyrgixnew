  ...
  return (
    <div className="min-h-screen pt-28 bg-gradient-to-b from-[#FCF2E5]/50 to-white">
      ...
      <main className="pt-6 pb-20">
                ...
                <div className="flex items-center gap-3">
                  ...
                  {selectedCategory !== "All Products" && (
                    <span className="text-[#5A5A5A] font-poppins text-sm">
                      in{" "}
                      <span className="text-[#F37303] font-medium">
                        {selectedCategory}
                      </span>
                    </span>
                  )}
                ...
                <AnimatePresence mode="wait">
                  {isLoading ? (
                    ...
                    >
                      ...
                      >
                        <svg
                          className="w-12 h-12 text-[#F37303]"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                      ...
                      <h3 className="text-[#171717] font-aeonik text-xl mb-2">
                        No products found
                      </h3>
            ...
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
              <div className="text-center lg:text-left">
                ...
                <p className="text-white/70 font-poppins text-sm sm:text-base max-w-md">
                  Our team is here to help you find the perfect healthcare
              ...
              <Link href="/contactus">
                <motion.button
                  ...
                  whileHover={{
                    scale: 1.05,
                    boxShadow: "0 20px 40px rgba(243, 115, 3, 0.4)",
                  }}
                  whileTap={{ scale: 0.95 }}
                >
        ...
        <MobileFilterButton onClick={toggleFilter} isOpen={isFilterOpen} />
      </main>
    </div>
  );
}
