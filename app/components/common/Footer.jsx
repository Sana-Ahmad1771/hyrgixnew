...
export default function Footer() {
  return (
    <section
      className="bg-[rgba(252,242,229,0.5)] relative w-full bg-no-repeat rounded-t-[100px] bg-cover"
      style={{
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between h-auto lg:h-[60vh] px-5 sm:px-10 md:px-20 lg:px-32 py-10 lg:py-0 gap-10 lg:gap-0">
        ...
        >
          ...
          >
            <Link
              href="/"
              className="flex rounded-4xl items-center justify-center w-30 h-12 bg-[#F37303]"
            >
              ...
              <div className="grid items-center p-2 grid-cols-3 bg-[#F5F5F5] h-10 w-12 rounded-r-full">
                ...
                <span></span> <span></span>
                <span className="w-1 h-1 relative -top-1 left-2 bg-[#F37303] rounded-full"></span>
                <span></span>
                <span className="w-1.5 h-1.5 relative right-1 bg-[#F37303] rounded-full"></span>
                <span></span>
                <span className="w-1 h-1 ml-2 relative left-4 -top-0.5 bg-[#F37303] rounded-full"></span>
              </div>
            </Link>
          </motion.div>
          ...
          >
            {navigation.map((item, index) => (
              ...
              >
                <Link href={item.href}>
                  <button className="px-6 sm:px-8 md:px-5 py-2 sm:py-3 cursor-pointer rounded-full bg-white text-black text-xs font-bold font-spline-sans transition-colors hover:bg-primary hover:text-white shadow-sm">
                    {item.text}
                  </button>
                </Link>
              </motion.div>
        ...
        >
          ...
          >
            ...
            <div className="relative z-10 flex flex-col items-center gap-4 sm:gap-6">
              <h2 className="text-lg sm:text-xl md:text-2xl font-medium text-gray-800 text-center">
                Have a query?
              </h2>
              {/* <motion.button
              ...
              >
                <Link
                  href="/#products"
                  className="relative flex items-center bg-black h-[50px] w-40 sm:w-48 md:w-56 pl-[6px] pr-8 rounded-full overflow-hidden shadow-md border border-black/5"
                >
