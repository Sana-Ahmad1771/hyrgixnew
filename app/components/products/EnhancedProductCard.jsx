...
export default function EnhancedProductCard({ product, index = 0 }) {
    ...
    return (
        <Link href={`/products/${id}`} className="block h-full">
            ...
            >
                {/* Image Section */}
                <div className="relative h-48 sm:h-56 overflow-hidden bg-gradient-to-br from-[#F8F8F8] to-[#F0F0F0]">
                    {/* Gradient Overlay */}
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        ...
                        >
                            ...
                            <Image 
                                ...
                                width={140}
                                height={140}
                                className="object-contain absolute top-2 left-4 opacity-30 blur-sm" 
                            />
                            {/* Main Image */}
                            <Image 
                                src={image} 
                                ...
                                width={140}
                                height={140}
                                className="object-contain relative z-10 drop-shadow-lg group-hover:drop-shadow-2xl transition-all duration-500" 
                            />
                        </motion.div>
                    </div>
                    ...
                    >
                        <span className="flex items-center justify-center w-10 h-10 bg-white rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-4 group-hover:translate-y-0">
                            <svg className="w-5 h-5 text-[#F37303]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="p-5 sm:p-6 flex flex-col grow">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-[#F0F0F0]">
                        <span className="text-[#888] font-poppins text-xs">
                            {quantity}
                        </span>
