    ...
    <section className="relative  overflow-hidden bg-gradient-to-br from-[#FCF2E5] via-[#FFF8F0] to-[#FCF2E5] py-16 sm:py-20 lg:py-24">
      ...
      <div className="mx-5 sm:mx-10 md:mx-20 lg:mx-32 relative z-10 pt-28">
        ...
        >
          ...
          <motion.h1
            variants={fadeUp}
            className="text-black font-aeonik text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-normal leading-tight mb-6"
          >
            Our Blog Health <br className="hidden lg:block" /> & Wellness
            Stories
          </motion.h1>
          ...
          >
            Discover expert insights, health tips, and the latest updates from
            Hygrix. Stay informed about hygiene best practices and wellness
            trends.
          </motion.p>
