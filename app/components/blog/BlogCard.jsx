    ...
    <Link href={`/blogs/${slug}`}>
      ...
      >
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-20 h-20 rounded-full bg-[#F37303]/20 flex items-center justify-center">
                <svg
                  className="w-10 h-10 text-[#F37303]"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        <div className="p-5 sm:p-6 flex flex-col flex-grow">
          ...
          {/* Title */}
          <h3 className="text-black font-aeonik text-lg sm:text-xl font-medium leading-tight mb-3 group-hover:text-[#F37303] transition-colors duration-300 line-clamp-2">
            {title}
          </h3>
